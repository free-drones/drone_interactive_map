...
import { Slider, FormGroup, FormControlLabel, Switch, Typography } from '@mui/material';
                ...
                <FormControlLabel
                    ...
                    control={
                        <Slider
                            ...
                            min={10}
                            max={30}
                            onChange={(e, val) => this.props.store.setConfigValue("droneIconPixelSize", val)}
                        />
                    }
                />
                <FormControlLabel
                    control={
                        <Switch
                            ...
                            onChange={(e, val) => this.props.store.setConfigValue("showDroneIcons", val)}
                        />
                    }
                    label="Visibility"
                />
